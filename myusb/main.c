...
// to show the clang defaults run this command:
// clang -dM -E -x c /dev/null

// kernel compiler include paths order:
...
// clang -dM -E -x c /dev/null defines:
// #define _LP64 1
...
// kernel compiler command line:

// clang -Wp,-MMD,drivers/scsi/.scsi.o.d -nostdinc -I./arch/arm64/include
...
// -D__KERNEL__ -mlittle-endian -DKASAN_SHADOW_SCALE_SHIFT= -Qunused-arguments
...
// -Werror=ignored-optimization-argument -mgeneral-regs-only
// -DCONFIG_CC_HAS_K_CONSTRAINT=1 -Wno-psabi -fno-asynchronous-unwind-tables
// -fno-unwind-tables -mbranch-protection=pac-ret+leaf+bti -Wa,-march=armv8.5-a
...
// -fno-var-tracking -mstack-protector-guard=sysreg
// -mstack-protector-guard-reg=sp_el0 -mstack-protector-guard-offset=
// -DKBUILD_MODFILE='"drivers/scsi/scsi_mod"' -DKBUILD_BASENAME='"scsi"'
// -DKBUILD_MODNAME='"scsi_mod"' -D__KBUILD_MODNAME=kmod_scsi_mod -c -o
// drivers/scsi/scsi.o drivers/scsi/scsi.c  ; scripts/basic/fixdep
// drivers/scsi/.scsi.o.d drivers/scsi/scsi.o